...
wget http://ppa.launchpad.net/stellarium/stellarium-releases/ubuntu/pool/main/s/stellarium/stellarium_24.1.0-upstream1.0~ubuntu22.04.1_arm64.deb
wget http://ppa.launchpad.net/stellarium/stellarium-releases/ubuntu/pool/main/s/stellarium/stellarium-data_24.1.0-upstream1.0~ubuntu22.04.1_all.deb
EOF
