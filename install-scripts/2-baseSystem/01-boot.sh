...
if [ -f /boot/cmdline.txt ]; then
  sed -i '$s/$/\ loglevel=1\ splash\ quiet\ logo.nologo\ vt.global_cursor_default=1\ plymouth.ignore-serial-consoles\ systemd.firstboot=off\ console=tty3\ rd.systemd.show_status=false/' /boot/cmdline.txt
