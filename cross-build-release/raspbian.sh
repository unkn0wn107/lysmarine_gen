...
EOF
  ...
  if [ "$BBN_KIND" == "LITE" ] ; then
    BBN_IMG=lysmarine-bbn-beta-lite-bookworm_"${LYSMARINE_VER}"-${thisArch}-${cpuArch}.img
  else
    BBN_IMG=lysmarine-bbn-beta-full-bookworm_"${LYSMARINE_VER}"-${thisArch}-${cpuArch}.img
  fi
